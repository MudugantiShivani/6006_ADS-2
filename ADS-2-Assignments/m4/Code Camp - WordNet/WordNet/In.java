...
public final class In {
  ...
  // assume language = English, country
  //= US for consistency with System.out.
  ...
  /**
    ...
    * {@link #hasNextChar()}.
    *
    * @return {@code true} if this input stream
  ...
  /**
    ...
    *
    * @return the next line in this input
    * stream; {@code null} if no such line
    */
  ...
  public String readAll() {
    ...
    // not that important to reset delimeter,
  ...
  /**
    * Reads the next token from this input stream and
  ...
  /**
    ...
    * @throws NoSuchElementException if the input stream is empty
    * @throws InputMismatchException if the next token
    * cannot be parsed as a {@code byte}
    */
   ...
   * (interpreting either {@code "true"} or {@code "1"}
   * as {@code true},
